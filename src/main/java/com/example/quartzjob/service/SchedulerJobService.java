package com.example.quartzjob.service;

import com.example.quartzjob.config.JobScheduleCreator;
import com.example.quartzjob.entity.SchedulerJobInfo;
import com.example.quartzjob.job.SimpleCronJob;
import com.example.quartzjob.job.SimpleJob;
import com.example.quartzjob.repo.SchedulerRepository;
...
public class SchedulerJobService {
    ...
    public void saveOrupdate(SchedulerJobInfo scheduleJob) throws Exception {
        ...
        scheduleJob.setDescN("i am job number " + scheduleJob.getJobId());
